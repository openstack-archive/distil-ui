            ...
            "invoices": {
                "2016-08-31": {
                    ...
                    "details": {'Compute': {'total_cost': 767.06, 'breakdown':
                                             {'NZ-POR-1.c1.c4r8': [{'rate': 0.248, 'resource_name': 'postgresql', 'cost': 184.51, 'unit': 'Hour(s)', 'quantity': 744.0}],
                                              'NZ-POR-1.c1.c8r32': [{'rate': 0.783, 'resource_name': 'docker', 'cost': 582.55, 'unit': 'Hour(s)', 'quantity': 744.0}]}
                                             }
                               }
                },
                "2016-09-30": {
