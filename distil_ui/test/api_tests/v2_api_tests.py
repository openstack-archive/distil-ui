...
fakeKeystoneClient = mock.MagicMock()
fakeKeystoneClient.regions.list = mock.Mock(return_value=region_list)
get_fakekeystoneclient = mock.Mock(return_value=fakeKeystoneClient)
...
@mock.patch('distil_ui.api.distil_v2.base', mock.MagicMock)
...
class V2BillingTests(test.TestCase):
    ...
    def test_get_history_cost(self):
        region_list[:] = []
